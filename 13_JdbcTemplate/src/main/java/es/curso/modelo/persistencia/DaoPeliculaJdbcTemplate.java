...
public class DaoPeliculaJdbcTemplate implements DaoPelicula {
	...
	//JdbcTemplate trabajacon consultas parametrizadas por defecto, ademas de que es la manera
	//recomendable
	/**
	 * @param la pelicla que queremos dar de alta
	...
	public int modificar(Pelicula p) {
		...
		//Al final el update sirve para modificar la BBDD
		int id= jdbcTemplate.update(query,
				p.getTitulo(),
				p.getDirector(),
				p.getGenero(),
	...
	public Pelicula buscar(int id) {
		...
		//Este metodo espera un unico regristro como resultado
		//Si devuelve mas, arrojaria una excepcion
